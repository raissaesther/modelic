...
function init_qode_theme_options() {
	...
	if(isset($qode_options['reset_to_defaults'])){
		if( $qode_options['reset_to_defaults'] == 'yes' ) delete_option( "qode_options_mondelic");
	}
	if (! get_option("qode_options_mondelic")) {
		add_option( "qode_options_mondelic",
...
function qodef_save_options() {
	...
	update_option( 'qode_options_mondelic', $qode_options );
