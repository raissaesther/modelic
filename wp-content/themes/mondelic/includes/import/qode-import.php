...
class Qode_Import {
    ...
    public function import_options($file){
        $options = $this->file_options($file);
        update_option( 'qode_options_mondelic', $options);
    ...
    function qode_generate_import_page() {
        ...
        <div id="qode-metaboxes-general" class="wrap qodef-page qodef-page-info">
            <h2 class="qodef-page-title"><?php _e('mondelic — One-Click Import', 'qode') ?></h2>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-3">
                                            ...
                                            <select name="import_example" id="import_example" class="form-control qodef-form-element">
												<option value="mondelic1">mondelic 1 - Anders</option>
												<option value="mondelic2">mondelic 2 - Bjorn</option>
												<option value="mondelic3">mondelic 3 - Claes</option>
												<option value="mondelic4">mondelic 4 - Daniel</option>
												<option value="mondelic5">mondelic 5 - Erland</option>
												<option value="mondelic6">mondelic 6 - Fredrik</option>
												<option value="mondelic7">mondelic 7 - Gustav</option>
												<option value="mondelic8">mondelic 8 - Hugo</option>
												<option value="mondelic9">mondelic 9 - Ingmar</option>
												<option value="mondelic10">mondelic 10 - Jonas</option>
												<option value="mondelic11">mondelic 11 - Kaleb</option>
												<option value="mondelic12">mondelic 12 - Lars</option>
												<option value="mondelic13">mondelic 13 - Magnus</option>
												<option value="mondelic14">mondelic 14 - Noel</option>
												<option value="mondelic15">mondelic 15 - Oskar</option>
												<option value="mondelic16">mondelic 16 - Petter</option>
												<option value="mondelic17">mondelic 17 - Roland</option>
												<option value="mondelic18">mondelic 18 - Sigfrid</option>
												<option value="mondelic19">mondelic 19 - Tomas</option>
												<option value="mondelic20">mondelic 20 - Viggo</option>
                                            </select>
                                        </div>
                                        <div class="col-lg-3">
                ...
                $j(document).on('click', '#import_demo_data', function(e) {
                    ...
                    if (confirm('Are you sure, you want to import Demo Data now?')) {
                        ...
                        if(import_opt == 'content'){
                            for(var i=1;i<10;i++){
                                var str;
                                if (i < 10) str = 'mondelic_content_0'+i+'.xml';
                                else str = 'mondelic_content_'+i+'.xml';
                                jQuery.ajax({
                                    type: 'POST',
                                    url: ajaxurl,
                                    data: {
