...
<?php } ?>
<div class="wrapper">
<div class="top-logo"><img src="http://nmds.cc/mondelic/wp-content/uploads/2016/05/logo-mondelic.png" alt="Mondelic"></div>
...
if (!empty($_SESSION['qode_mondelic_header_top'])){
	$display_header_top = $_SESSION['qode_mondelic_header_top'];
}
