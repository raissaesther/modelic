...
$j(document).ready(function() {
    ...
    $j('ul#tootlbar_header_top_menu li').click(function(){
        if($j(this).attr("data-value") != ""){
            ...
            $j.post(qode_root+'updatesession.php', {mondelic_header_top : $j(this).attr("data-value")}, function(data){
                location.reload();
            });
        }
    });
    ...
    $j('ul#tootlbar_page_transitions li').click(function(){
        if($j(this).attr("data-value") != ""){
            ...
            $j.post(qode_root+'updatesession.php', {mondelic_page_transitions : $j(this).attr("data-value")}, function(data){
                location.reload();
            });
        }
    });
    ...
    $j('ul#tootlbar_header_type li').click(function(){
        if($j(this).attr("data-value") != ""){
            $j.post(qode_root+'updatesession.php', {mondelic_header_type : $j(this).attr("data-value")}, function(data){
                location.reload();
            });
        }
    });
